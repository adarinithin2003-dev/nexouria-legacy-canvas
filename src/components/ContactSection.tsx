      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="glass-strong rounded-2xl p-8 md:p-12 mb-8 card-glow"
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full btn-gradient btn-shimmer btn-glow text-background font-semibold"
            >
          ...
          >
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-whatsapp text-white font-medium text-base transition-all duration-300 shadow-lg shadow-whatsapp/30 btn-shimmer"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white font-medium text-base transition-all duration-300 shadow-lg btn-shimmer"
            >
